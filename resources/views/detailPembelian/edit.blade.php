...
<html lang="en">
    <head>
        ...
        <meta name="detailPembelian" content="">
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">detailPembelian</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- TABLE -->
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                Edit Data detailPembelian
                            </div>
                            <form Action="{{ route('detailPembelian.update',$detailPembelian->id)}}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('put')
