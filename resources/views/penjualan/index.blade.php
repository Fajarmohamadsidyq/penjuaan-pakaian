                    ...
                    <div class="row">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                               Data Penjualan
                               <a href="{{ route('penjualan.create')}}" class="btn btn-primary float-right">Tambah</a>
                            </div>
                            <!-- /.panel-heading -->
                                    ...
                                    <table class="table">
                                        ...
                                        @foreach($penjualan as $data)
                                            <tr>
                                                ...
                                                <a href="{{route('penjualan.edit',$data->id)}}" class="btn btn-success float-right">Edit</a>
                                                <a href="{{route('penjualan.show',$data->id)}}" class="btn btn-warning float-right">Show</a>
