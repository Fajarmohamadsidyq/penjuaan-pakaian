                    ...
                    <div class="row">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                               Data stok
                               <a href="{{ route('stok.create')}}" class="btn btn-primary float-right">Tambah</a>
                            </div>
                            <!-- /.panel-heading -->
                                    ...
                                    <table class="table">
                                        ...
                                        @foreach($stok as $data)
                                            <tr>
                                                ...
                                                <a href="{{route('stok.edit',$data->id)}}" class="btn btn-success float-right">Edit</a>
                                                <a href="{{route('stok.show',$data->id)}}" class="btn btn-warning float-right">Show</a>
