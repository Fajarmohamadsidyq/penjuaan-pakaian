                                    ...
                                    <table class="table">
                                        ...
                                        @foreach($pelanggan as $data)
                                            <tr>
                                                ...
                                                <a href="{{route('pelanggan.edit',$data->id)}}" class="btn btn-success float-right">Edit</a>
                                                <a href="{{route('pelanggan.show',$data->id)}}" class="btn btn-warning float-right">Show</a>
