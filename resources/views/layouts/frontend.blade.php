			...
			<div id="top-header">
				<div class="container">
					<ul class="header-links pull-left">
						<li><a href="#"><i class="fa fa-phone"></i> +6289656241196</a></li>
						<li><a href="#"><i class="fa fa-envelope-o"></i> Fajarmuhamadsidiq@gmail.com</a></li>
						<li><a href="#"><i class="fa fa-map-marker"></i> Jln. Moh Tohha</a></li>
					</ul>
				</div>
			</div>
			<!-- /TOP HEADER -->
