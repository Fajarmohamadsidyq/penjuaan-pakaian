                                    ...
                                    <table class="table">
                                        ...
                                        @foreach($pembayaran as $data)
                                            <tr>
                                                ...
                                                <a href="{{route('pembayaran.edit',$data->id)}}" class="btn btn-success float-right">Edit</a>
                                                <a href="{{route('pembayaran.show',$data->id)}}" class="btn btn-warning float-right">Show</a>
